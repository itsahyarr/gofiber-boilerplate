...
type MockUserRepository struct {
	...
	FindAllFunc       func(ctx context.Context, page, pageSize int) ([]*entity.User, int64, error)
...
func (m *MockUserRepository) FindAll(ctx context.Context, page, pageSize int) ([]*entity.User, int64, error) {
